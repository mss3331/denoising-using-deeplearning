...
sk_jaccard = [sk.precision_score(truenp[i], prednp[i]) for i in range(batch)]
...
#-------------- Torch metrics ----------------
start = time.time()
torch_jaccard_mean = calculate_metrics_torch(true, pred,metrics='precision',reduction='mean')
