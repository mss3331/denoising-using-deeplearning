...
from models.helpers.Res2Net_v1b import res2net50_v1b_26w_4s, res2net101_v1b_26w_4s
import math
import torchvision.models as models
from .helpers.CaraNet_extraHelpters.conv_layer import Conv, BNPReLU
from .helpers.CaraNet_extraHelpters.axial_atten import AA_kernel
from .helpers.CaraNet_extraHelpters.context_module import CFPModule
from .helpers.CaraNet_extraHelpters.partial_decoder import aggregation
import os
...
class caranet(nn.Module):
    def __init__(self, pretrained, channel=32):
        super().__init__()
        
         # ---- ResNet Backbone ----
        self.resnet = res2net101_v1b_26w_4s(pretrained=pretrained)
